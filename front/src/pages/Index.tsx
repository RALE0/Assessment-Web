          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-green-100 hover:border-green-200">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Monitoreo de Cultivos Inteligente</h3>
                <p className="text-gray-600">
                  Seguimiento continuo del rendimiento esperado y condiciones óptimas 
                  de crecimiento para más de 22 tipos de cultivos diferentes.
                </p>
              </CardContent>
            </Card>
